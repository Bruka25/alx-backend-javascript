The following javascript codes are for the ALX 0x04-TypeScript project for the alx-backend-javascript curriculum, inside it contains the following javascript codes:
